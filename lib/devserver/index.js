...
function runWithNodemon() {
  ...
  // #region Exit On Q - Not working
  // Exit the process when stdin data starts with a q.
  // Not working! See  https://github.com/remy/nodemon/issues/631
  //process.stdin.on('data', function (data) {
  //  data = data.toString();
  //  if (data.charCodeAt(0) === 113) { // q
  //    //nodemon.reset();
  //    process.exit();
  //  }
  //});
