...
function renderView(req, res, next) {
  ...
  // TODO: Replace the rest of the yucky code in this function with 
  // consolidate.js or something like it (or copy from it).
  if (ext === '.jade') {
    ...
    context = lodash.assign({}, context, build.engine.nunjucks.functions);
